...
*new()* function can take any Hashable data, but for simplicity we will test merkle tree over **H256**, whose Hashable trait is already provided inside *src/crypto/hash.rs*.
